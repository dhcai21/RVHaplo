...
optional arguments:
    ...
    -s  | --smallest_snv INT :         Smallest # of SNV sites for haplotype construction. (default: 20)
    -or | --overlap_read INT :         Minimum overlap between two reads in the read graph. (default: 5)
